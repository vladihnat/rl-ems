...
# Référence MILP du sweep exp25, pendant de scripts/rl/run_exp25.sh. exp25 utilise les MÊMES données
...
# exp21b ; seuls les noms de sortie changent (milp_exp25_*).
#
# Usage : ./scripts/milp/run_exp25.sh [CASE] [extra python args...]
...
OUT="monitoring/runs/milp_exp25_${WINDOW}_monitoring_table.csv"
PLAN_OUT="monitoring/runs/milp_exp25_${WINDOW}_plan.csv"
...
echo "[sim] exp25 MILP | case=$CASE | PV=$PV | load=$LOAD -> $OUT"
