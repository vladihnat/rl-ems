...
CONFIG="results/exp05_cc_quadBat_300kBS_g99/config_used.yaml"
MODEL="results/exp05_cc_quadBat_300kBS_g99/sac_model.zip"
OUT="monitoring/runs/rl_exp05_qBt_300_99_monitoring_table.csv"
